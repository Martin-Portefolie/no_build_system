...
class TodoHandlerController extends AbstractController
{
    ...
    #[Route('/profile/todo-handler/{week?}-{year?}', name: 'app_todo_handler', methods: ['GET'])]
    public function index(Request $request, int $week = null, int $year = null): Response
    {
        ...
        return $this->render('profile/todo_handler/index.html.twig', [
            'week' => $week,
            'year' => $year,
            'weeklyData' => $data,
